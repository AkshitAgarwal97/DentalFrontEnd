                ...
                <div class="owl-carousel-3col owl-nav-top mb-sm-0" data-nav="true">
                    ...
                    <article class="post clearfix maxwidth600 mb-30 wow fadeInRight" data-wow-delay=".2s">
                      <div class="entry-header">
                        <div class="post-thumb thumb">
                          <img src="assets/images/blog/16.jpg" alt="" class="img-responsive img-fullwidth" />
                        </div>
                      </div>
                  ...
                  <div class="item">
                    <article class="post clearfix maxwidth600 mb-30 wow fadeInRight" data-wow-delay=".2s">
                      <div class="entry-header">
                        <div class="post-thumb thumb">
                          <img src="assets/images/blog/17.jpg" alt="" class="img-responsive img-fullwidth" />
                        </div>
                      </div>
                      <div class="bg-theme-colored2 p-5 text-center pt-10 pb-10">
                        <span class="mb-10 text-white mr-10 font-13"><i class="fa fa-calendar mr-5 text-white"></i>21 February</span>
                  ...
                  <div class="item">
                    <article class="post clearfix maxwidth600 mb-30 wow fadeInRight" data-wow-delay=".2s">
                      <div class="entry-header">
                        <div class="post-thumb thumb">
                          <img src="assets/images/blog/18.jpg" alt="" class="img-responsive img-fullwidth" />
                        </div>
                      </div>
                      <div class="bg-theme-colored2 p-5 text-center pt-10 pb-10">
                        <span class="mb-10 text-white mr-10 font-13"><i class="fa fa-calendar mr-5 text-white"></i>21 February</span>
                  ...
                  <div class="item">
                    <article class="post clearfix maxwidth600 mb-30 wow fadeInRight" data-wow-delay=".2s">
                      <div class="entry-header">
                        <div class="post-thumb thumb">
                          <img src="assets/images/blog/19.jpg" alt="" class="img-responsive img-fullwidth" />
                        </div>
                      </div>
                      <div class="bg-theme-colored2 p-5 text-center pt-10 pb-10">
                        <span class="mb-10 text-white mr-10 font-13"><i class="fa fa-calendar mr-5 text-white"></i>21 February</span>
